 ...
 * 
 * Original author: Wolff (wolff@google.com), 2013
 */
...
import com.tbggwp.imit.R;


/**
 * @author Mads Mello (mmgunder@gmail.com), 2014
 */
public class ImitActivity extends BaseGameActivity implements OnInvitationReceivedListener,
    ...
    public void setViewVisibility() {
        ...
        ((TextView) findViewById(R.id.name_field)).setText("Logged in as " + Games.Players.getCurrentPlayer(
    ...
    public void updateMatch(TurnBasedMatch match) {
        ...
        switch (turnStatus) {
            case TurnBasedMatch.MATCH_TURN_STATUS_MY_TURN:
                mTurnData = ImitTurn.unpersist(mMatch.getData());
                setGameplayUI();
                return;
